...
public class CacheService : ICacheService
{
    ...
    public async Task RemoveAsync(string key, CancellationToken cancellationToken)
    {
        ...
        {
            _logger.LogError(ex, "Error removing cache for key: {key}. Message: {Message}", key, ex.Message);
        }
    }
    ...
    public async Task<T?> GetAsync<T>(string key, CancellationToken cancellationToken)
    {
        ...
        {
            _logger.LogError(ex, "Error retrieving cache for key: {key}. Message: {Message}", key, ex.Message);
        }
        return default;
    }
    ...
    {
        await AddAsync(key, value, DefaultExpiration, cancellationToken);
    }

    public async Task AddAsync<T>(string key, T value, TimeSpan expiration, CancellationToken cancellationToken)
    {
        try
        {
            if (_localizationService.CurrentLanguage != null)
        ...
        {
            _logger.LogError(ex, "Error adding cache for key: {key}. Message: {Message}", key, ex.Message);
        }
    }
    ...
    public async Task ClearCache(CancellationToken cancellationToken)
    {
        ...
        {
            _logger.LogError(ex, "Error during cache clearing on startup. Message: {Message}", ex.Message);
        }
    }
}
