    ...
    where T : BaseEntity
{
    public void Configure(EntityTypeBuilder<T> builder)
    {
        ...
        if (typeof(IWithResumeParseData).IsAssignableFrom(typeof(T)))
        {
            builder.Property(nameof(IWithResumeParseData.ParsedData)).HasConversion<ResumeParseDataJsonConverter>();
        }
