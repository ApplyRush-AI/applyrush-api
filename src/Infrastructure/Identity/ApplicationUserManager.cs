...
public class ApplicationUserManager : UserManager<ApplicationUser>, IApplicationUserManager
{
    ...
    public override async Task<IList<Claim>> GetClaimsAsync(ApplicationUser user)
    {
        ...
        claims.Add(new Claim(Configuration.IdentityConstants.Claims.FirstName, user.FirstName ?? string.Empty));
        claims.Add(new Claim(Configuration.IdentityConstants.Claims.LastName, user.LastName ?? string.Empty));
