...
public class ApiExceptionFilterAttribute : ExceptionFilterAttribute
{
    ...
    public ApiExceptionFilterAttribute()
    {
        ...
        _exceptionHandlers = new Dictionary<Type, Action<ExceptionContext, bool>>
        {
            ...
            { typeof(InsufficientCreditsException), HandleInsufficientCreditsException },
        };
    }
    ...
    private void HandleInsufficientCreditsException(ExceptionContext context, bool handleInnerException)
    {
        var exception = !handleInnerException
            ? (InsufficientCreditsException)context.Exception
            : (InsufficientCreditsException)context.Exception.InnerException!;
